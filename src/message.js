module.exports = {
  ...
  HELP_DETAIL: '登録して<break time="0.3s"/>というとゴミの日を登録できます。削除して<break time="0.3s"/>というと登録済みのゴミの日を削除できます。教えて<break time="0.3s"/>というと今日と明日のゴミをお知らせします。それぞれ例えば<break time="0.3s"/>月曜日のゴミを教えて<break time="0.3s"/>のように曜日を指定することもできます。',
}
